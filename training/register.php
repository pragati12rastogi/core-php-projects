...
function match()
{
	...
	if(a.value.length == 0 || a.value.length <= 6 || a.value.length >12 || a.value.match(/^[0-9][A-Za-z]+$/))
	{
		alert('password is not secure! should be between 6 to 12 and be in alphanumeric');
		a.focus();
		return false;
