											...
											foreach($_FILES["files"]["tmp_name"] as $key=>$tmp_name)
													{
														...
														//$file_name.=$_FILES["files"]["name"][$key];  //this line is used to concatinate multiple
													...
													$sql = "INSERT INTO `slider`( `email`, `image`) VALUES ('$email','$file_name')";
													$v= mysqli_query($conn,$sql); 
												}
												/* print_r($file_name);
											$imag=implode(",",$file_name)
	$sql = "INSERT INTO `slider`( `email`, `image`) VALUES ('$email','$imag')"; */
											// print_r($file_name);
	//$sql = "INSERT INTO `slider`( `email`, `image`) VALUES ('$email','$file_name')";
													       // $v= mysqli_query($conn,$sql); 
										}
											...
											<form method="post" enctype="multipart/form-data">
												<h5>Create Slider:</h5> <input type="file" name="files[]" multiple /></br>
