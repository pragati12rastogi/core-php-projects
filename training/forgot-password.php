  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-6 card-panel">
      <form class="login-form" method="post">
        ...
        <div class="row">
          <div class="input-field col s12">
            <input type="submit" name="recover" value="Recover" class="btn waves-effect waves-light col s12">
          </div>
        </div>
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="login_reg.php">Login</a></p>
          </div>          
        </div>
