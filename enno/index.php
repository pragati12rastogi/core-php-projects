		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<?php
						...
						$sql= "SELECT * from logo where email = '".$_SESSION['email']."'  ";
	
						$res = mysqli_query($conn, $sql);
	
						if(mysqli_num_rows($res))
						{
							$row= mysqli_fetch_assoc($res);  //dont use loop
							
								echo "<a class='navbar-brand' href='index.php'><span>".$row['logo']."</span></a>";
...
$conn= mysqli_connect('localhost','root','','form');
	...
	$sql= "SELECT * from menu where user_id = '".$_SESSION['email']."'  ";
	...
	if($get_count)
	{
		...
		{
		echo "<li role='presentstion'><a href=# >".$row['menu']."</a></li>";
		}
				...
				<div class="img-responsive">
					<ul class="bxslider">
						<?php
								...
								$imag= "SELECT image FROM `slider` WHERE email= '".$_SESSION['email']."' ";
								
								$img = mysqli_query($conn, $imag);
								
								$get_num = mysqli_num_rows($img);
								if($get_num)
								{	
									while($row=mysqli_fetch_array($img))
									{
										echo "<li><img src='".$row['image']."'style= 'width:1127px;height:469px' /></li>";
									}
								}
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 f-about">
						<a href="index.php"><h1><span>e</span>Nno</h1></a>
					...
					<div class="col-md-4 l-posts">
						...
						<?php
						$sel="SELECT 'title' FROM 'post' where email = '".$_SESSION['email']."' ";
						
						$sel_conn=mysqli_query($conn,$sel);
						print_r($sel_conn);
						$get_sel=mysqli_num_rows($sel_conn);
						
						if($get_sel)
								{	
									while($row=mysqli_fetch_array($sel_conn))
									{
										echo "<ul><li><a href='#'>'".$row["title"]."'</a></li></ul>";
									}
								}
